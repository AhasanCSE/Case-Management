...
<?php $table_heading = "Location";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
<?php $targetpage="locations.php"?>
<?php $where="";?>
<?php 
...
<?php if(isset($_POST['sub']))
{
    ...
    $sql="INSERT INTO location SET LOCATION_NAME='$title',CREATED_BY='$user_no',CREATED_ON='$CURR_TIME'";
...
<?php
	...
	$sql= "SELECT *FROM location WHERE IS_DELETED=0 AND LOCATION_NO='$LOCATION_NO'";
...
<form class="cmxform form-horizontal " id="view_form" method="post" action="" enctype="multipart/form-data"  >
         ...
         <input type ="hidden" name = "LOCATION_NO" value = "<?php echo $LOCATION_NO ; ?>">
         
        <div class="form-group ">
            <label for="bn_title" class="control-label col-lg-2">Title</label>
            <div class="col-lg-8">
                <input class=" form-control" id="" name="title" type="text" value="<?= $paic['LOCATION_NAME']?>"  />
            </div>
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-lg-5">
             ...
             <a  href="locations.php" class="btn btn-primary"><i class="fa fa-back" aria-hidden="true"></i>Back</a>
 ...
 <?php
   ...
   $id=$_POST['LOCATION_NO'];
  
    $title=$_POST['title'];
    
    
         $sql="UPDATE location SET LOCATION_NAME='$title',UPDATED_BY='$user_no',UPDATED_ON='$CURR_TIME' WHERE LOCATION_NO='$id'";
...
<?php
    ...
    $id=$_GET['delete'];
     $sql="UPDATE location SET IS_DELETED=1 WHERE LOCATION_NO='$id'";
    $res= mysqli_query($con,$sql);
...
?>
 ...
 <form class="cmxform form-horizontal " id="signupForm" method="post" action="" enctype="multipart/form-data" style='display:none;' >
        ...
        <div class="form-group ">
            <label for="bn_title" class="control-label col-lg-2">Location/City</label>
            <div class="col-lg-8">
...
<table id="table_hide" class="table table-bordered" style ="margin-top:50px;">
    ...
    <?php
    // echo $where;
	$sql= "SELECT *FROM location WHERE IS_DELETED=0 ";
	$sql .= $where ;
	...
	?>
    	...
    	<tr>
        	...
        	<td>
        	   ...
        	   <center> 
        	   <a id="view" onclick="return confirm('Are you Sure Want to View?');" href="<?=$targetpage.'?edit='.$row['LOCATION_NO']?>" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
               <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['LOCATION_NO']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
               </center>
...
function reLocate()
{
    window.location.href="/advocate/soft/locations.php";
}
