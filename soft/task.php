...
<?php $table_heading = "Tasks";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
<?php $targetpage="task.php"?>
<?php $where="";$mgs="";?>
<?php 
 ...
 <form class="cmxform form-horizontal " id="signupForm" method="post" action="" enctype="multipart/form-data" style='display:none;' >
    ...
    <div class="form-group">
            <div class="col-lg-offset-2 col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-lg-5">
               ...
               <a  href="task.php" class="btn btn-primary"><i class="fa fa-back" aria-hidden="true"></i>Back</a>
...
function reLocate()
{
    window.location.href="/advocate/soft/task.php";
}
