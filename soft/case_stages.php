...
<?php $table_heading = "Case Stages";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
<?php $targetpage="case_stages.php"?>
<?php $where="";?>
<?php 
...
<?php if(isset($_POST['sub']))
{
    ...
    $sql="INSERT INTO case_stage SET CASE_STAGE_NAME='$title',CREATED_BY='$user_no',CREATED_ON='$CURR_TIME'";
    $res=mysqli_query($con,$sql);
    
    if($res)
    {
        $mgs="insert";
         //echo "<meta http-equiv='refresh' content='0; url=case_stages.php' />";
...
<?php
    ...
    $CASE_STAGE_NO=$_GET['edit'];
	$sql= "SELECT *FROM case_stage WHERE IS_DELETED=0 AND CASE_STAGE_NO='$CASE_STAGE_NO'";
...
<form class="cmxform form-horizontal " id="view_form" method="post" action="" enctype="multipart/form-data"  >
         ...
         <input type ="hidden" name = "CASE_STAGE_NO" value = "<?php echo $CASE_STAGE_NO ; ?>">
         
        <div class="form-group ">
            <label for="bn_title" class="control-label col-lg-2">Name</label>
            <div class="col-lg-8">
                <input class=" form-control" id="" name="title" type="text" value="<?= $paic['CASE_STAGE_NAME']?>"  />
            </div>
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-lg-5">
             ...
             <a  href="case_stages.php" class="btn btn-primary"><i class="fa fa-back" aria-hidden="true"></i>Back</a>
 ...
 <?php
   ...
   $id=$_POST['CASE_STAGE_NO'];
  
    $title=$_POST['title'];
    
    
         $sql="UPDATE case_stage SET CASE_STAGE_NAME='$title',UPDATED_BY='$user_no',UPDATED_ON='$CURR_TIME' WHERE CASE_STAGE_NO='$id'";
...
<?php
    ...
    $id=$_GET['delete'];
     $sql="UPDATE case_stage SET IS_DELETED=1 WHERE CASE_STAGE_NO='$id'";
    $res= mysqli_query($con,$sql);
...
<table id="table_hide" class="table table-bordered" style ="margin-top:50px;">
    ...
    <?php
    // echo $where;
	$sql= "SELECT *FROM case_stage WHERE IS_DELETED=0 ";
	$sql .= $where ;
	...
	?>
    	...
    	<tr>
        	<td><?=$i++?></td>
        	<td><?=$row['CASE_STAGE_NAME']?></td>
        
        	<td>
        	    
        	   <center> 
        	   <a id="view" onclick="return confirm('Are you Sure Want to View?');" href="<?=$targetpage.'?edit='.$row['CASE_STAGE_NO']?>" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
               <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['CASE_STAGE_NO']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
               </center>
...
function reLocate()
{
    window.location.href="/advocate/soft/case_stages.php";
}
