...
<?php $table_heading = "User Roles List";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
<?php $targetpage="user_role.php"?>
<?php $where=""; $mgs = ""  ?>
<?php 
...
<?php if(isset($_POST['sub']))
{
    ...
    $sql="INSERT INTO user_role SET TITLE='$title',DESCRIPTION='$description',CREATED_BY='$user_no',CREATED_ON='$CURR_TIME'";
...
<?php
    ...
    $client_no=$_GET['edit'];
	$sql= "SELECT *FROM user_role WHERE IS_DELETED=0 AND ROLE_NO='$client_no'";
...
<form class="cmxform form-horizontal " id="view_form" method="post" action="" enctype="multipart/form-data"  >
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-lg-5">
             ...
             <a  href="user_role.php" class="btn btn-primary"><i class="fa fa-back" aria-hidden="true"></i>Back</a>
 ...
 <?php
   ...
   $id=$_POST['member_no'];
    ...
    $desc=$_POST['desc'];
         ...
         $sql="UPDATE user_role SET TITLE='$title',DESCRIPTION='$desc',IS_UPDATED=1,UPDATED_BY='$user_no',UPDATED_ON='$CURR_TIME' WHERE ROLE_NO='$id'";
...
<?php
    ...
    $id=$_GET['delete'];
     $sql="UPDATE user_role SET IS_DELETED=1 WHERE ROLE_NO='$id'";
    $res= mysqli_query($con,$sql);
     if($res)
    {
        $mgs="delete";
...
<table id="table_hide" class="table table-bordered" style ="margin-top:50px;">
    ...
    <?php
    // echo $where;
	$sql= "SELECT *FROM user_role WHERE IS_DELETED=0 ";
	$sql .= $where ;
	...
	?>
    	...
    	<tr>
        	...
        	<td>
        	   ...
        	   <center> 
        	   <a id="view" id="hide" onclick="return confirm('Are you Sure Want to View?');" href="<?=$targetpage.'?edit='.$row['ROLE_NO']?>" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
               <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['ROLE_NO']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
               </center>
...
function reLocate()
{
    window.location.href="/advocate/soft/user_role.php";
}
