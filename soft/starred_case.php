...
<?php $table_heading = "Star Cases";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
<?php $targetpage="starred_case.php"?>
<?php $where="";$mgs="";?>
<?php 
      ...
      <div class="col-md-10">   
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-lg-5">
               ...
               <a  href="starred_case.php" class="btn btn-primary"><i class="fa fa-back" aria-hidden="true"></i>Back</a>
...
<table id="table_hide" class="table table-bordered" style ="margin-top:50px;">
    ...
    <?php
    // echo $where;
	$sql= "SELECT `ALL_CASES_NO`, `ALL_CASES_TITLE`,ALL_CASES_NO,all_cases.IS_ARCHIVED,`ALL_CASES_CASE_NO`,`IS_STAR`, clients.CLIENTS_NAME FROM
	all_cases LEFT JOIN clients ON all_cases.ALL_CASES_CLIENT_NAME=clients.CLIENTS_NO WHERE all_cases.IS_ARCHIVED='0' AND all_cases.IS_DELETED='0' AND all_cases.IS_STAR='1'";
	$sql .= $where ;
...
function reLocate()
{
    window.location.href="/advocate/soft/starred_case.php";
}
