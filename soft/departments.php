...
<?php $table_heading = "Departments List";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
<?php $targetpage="departments.php"?>
<?php $where="";?>
<?php 
...
<?php if(isset($_POST['sub']))
{
    ...
    $sql="INSERT INTO department SET TITLE='$title',DESCRIPTION='$description',CREATED_BY='$user_no',CREATED_ON='$CURR_TIME'";
...
<?php
    ...
    $client_no=$_GET['edit'];
	$sql= "SELECT *FROM department WHERE IS_DELETED=0 AND DEPARTMENT_NO='$client_no'";
...
<form class="cmxform form-horizontal " id="view_form" method="post" action="" enctype="multipart/form-data"  >
        ...
        <div class="form-group">
            <div class="col-lg-offset-2 col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-lg-5">
             ...
             <a  href="departments.php" class="btn btn-primary"><i class="fa fa-back" aria-hidden="true"></i>Back</a>
 ...
 <?php
   ...
   $id=$_POST['member_no'];
    ...
    $desc=$_POST['desc'];
         ...
         $sql="UPDATE department SET TITLE='$title',DESCRIPTION='$desc',IS_UPDATED=1,UPDATED_BY='$user_no',UPDATED_ON='$CURR_TIME' WHERE DEPARTMENT_NO='$id'";
...
<?php
    ...
    $id=$_GET['delete'];
     $sql="UPDATE department SET IS_DELETED=1 WHERE DEPARTMENT_NO='$id'";
    $res= mysqli_query($con,$sql);
	...
	?>
    	...
    	<tr>
        	...
        	<td>
        	   ...
        	   <center> 
        	   <a id="view" onclick="return confirm('Are you Sure Want to View?');" href="<?=$targetpage.'?edit='.$row['DEPARTMENT_NO']?>" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
               <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['DEPARTMENT_NO']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
               </center>
...
function reLocate()
{
    window.location.href="/advocate/soft/departments.php";
}
